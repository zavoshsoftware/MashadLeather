...
namespace MashadLeatherEcommerce.Controllers
{
    ...
    public class StepDiscountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,ExpireDate,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description,DescriptionEn")] StepDiscount stepDiscount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,ExpireDate,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description,DescriptionEn")] StepDiscount stepDiscount)
        {
            if (ModelState.IsValid)
            {
                stepDiscount.IsDeleted = false;
                stepDiscount.LastModifiedDate = DateTime.Now;
